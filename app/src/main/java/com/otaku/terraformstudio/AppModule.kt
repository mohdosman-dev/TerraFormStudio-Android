...
import com.otaku.terraformstudio.features.checkout.data.checkoutModule
...
val appModule = module {
    includes(coreDataModule, homeModule, cartModule, productModule, artisanModule, makersModule, authModule, checkoutModule)
}
